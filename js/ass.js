function taoDoiTuongSanPham(hinhAnh, ten, giaGoc, id) {
    ...
    sanPham.fromJSON = function(json){
        ...
        var sanPhamDayDu = taoDoiTuongSanPham(doiTuong.hinhAnh, doiTuong.ten, doiTuong.giaGoc);
        return sanPhamDayDu;
    }
    return sanPham;
}
...
function chuyenDoiTuongSanPhamThanhHTML2(sanPham){
    ...
    HTML = HTML + '<button onclick = "onClickDuaVaoGioHang(\''+ sanPham.id +'\')" class="btn"> Đưa vào giỏ hàng </button>';
    HTML = HTML + "</div>";
    return HTML;
}
